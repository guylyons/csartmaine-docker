                ...
                <div class="instashow-demo-accordion-item-content">
                    <div class="instashow-demo-source instashow-demo-field-group">
                        ...
                        <div class="instashow-demo-field-group-description">
                            <?php _e('You can add any combination of @username, #hashtag and Instagram photo URL.', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?>
                        </div>
                    ...
                    <div class="instashow-demo-filter instashow-demo-field-group">
                        <input type="hidden" name="filterExcept[]">
                        <input type="hidden" name="filterOnly[]">

                        <div class="instashow-demo-field-group-name"><?php _e('Filter', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></div>

                        <div class="instashow-demo-field">
                            <div class="instashow-demo-field-description">
                                <?php _e('Filter Instagram photos by setting various conditions. Include or exclude images by using different combinations of @username, #hashtag and photo URL.', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?>
                            </div>

                            <div class="instashow-demo-filter-items">
                                <template class="instashow-demo-template-filter-item instashow-demo-template">
                                    <div class="instashow-demo-filter-item">
                                        <div class="instashow-demo-filter-item-type">
                                            <select name="filterType" class="instashow-demo-select">
                                                <option value="filterExcept"><?php _e('Except', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></option>
                                                <option value="filterOnly"><?php _e('Only', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></option>
                                            </select>
                                        </div>

                                        <div class="instashow-demo-filter-item-input">
                                            <input type="hidden" class="instashow-demo-tags" name="filterValue" placeholder="<?php _e('add a source', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?>">
                                        </div>

                                        <div class="instashow-demo-filter-item-remove"></div>
                                    </div>
                                </template>
                            </div>

                            <button class="instashow-demo-filter-add-item">
                                <span class="instashow-demo-icon-plus instashow-demo-icon"></span>
                                <span class="instashow-demo-filter-add-item-label"><?php _e('Add condition', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="instashow-demo-field-group">
                        <div class="instashow-demo-limit instashow-demo-field">
                            <div class="instashow-demo-field-name-inline instashow-demo-field-name"><?php _e('Limit photos', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></div>
                            ...
                            <span class="instashow-demo-field-hint"><?php _e('set "0" to show all photos', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?></span>
                        </div>
                    </div>
